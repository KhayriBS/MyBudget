...
public class AddTransactionActivity extends AppCompatActivity {
    ...
    private tn.esprit.mybudget.ui.viewmodel.AccountViewModel accountViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accountViewModel = new ViewModelProvider(this).get(tn.esprit.mybudget.ui.viewmodel.AccountViewModel.class);
